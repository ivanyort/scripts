...
Dockur
```
docker run -it --name win1 --add-host=demo.labsp.com:host-gateway --restart always --net demo-net -p 8006:8006 -p 4389:3389 --device=/dev/kvm --cap-add NET_ADMIN --stop-timeout 120 -e "VERSION=2022" -e "RAM_SIZE=16G" -e "CPU_CORES=8" -e "DISK_SIZE=256G" dockurr/windows
```
