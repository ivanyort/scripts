...
docker run --name kafka --restart always --net demo-net -v /mnt/c/Users/gpl/OneDrive/github/qlik-data-integration/replicate/ivayt:/media -d -p 2181:2181 -p 3030:3030 -p 8081-8083:8081-8083 -p 9581-9585:9581-9585 -p 9092:9092 lensesio/fast-data-dev:latest
```
Portainer
```
