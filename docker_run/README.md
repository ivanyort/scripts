...
```
docker run --name sqlserver --restart always --net demo-net -p 1433:1433 -e "ACCEPT_EULA=Y" -e "MSSQL_SA_PASSWORD=Qlik123$" -e "MSSQL_AGENT_ENABLED=1" -d ivanyort/sqlserver-2019
...
docker run --name demo-apps --restart always --net demo-net  -d -p 8080:80 ivanyort/demo-apps
