...
docker run -d --name minio --add-host=demo.labsp.com:host-gateway --restart always --net demo-net -p 9000:9000 -p 9001:9001 -e MINIO_ROOT_USER=qlik -e MINIO_ROOT_PASSWORD=Qlik123$ minio/minio:RELEASE.2025-04-22T22-12-26Z server /data --console-address ":9001"
```
Portainer
```
